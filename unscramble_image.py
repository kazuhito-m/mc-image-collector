...
scramble = [12, 3, 1, 15, 6, 8, 10, 4, 9, 5, 14, 13, 0, 2, 7, 11]
...
for i, scramble_pos in enumerate(scramble):
    i = i % TILE_SIZE
    y = i // TILE_SIZE
    ...
    # image_tile = image_tiles[scramble_pos]
    # unscramble_image.paste(image_tile, (left, top))
